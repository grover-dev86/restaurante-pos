      ...
      <header className="bg-background border-b">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-semibold">Restaurante POS</h1>
          </div>
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Este es tu panel de control. Aquí podrás gestionar todas las operaciones del restaurante.
          </p>
        </div>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                Próximamente: reportes en tiempo real
              </p>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <dl className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <dd className="text-sm capitalize">{session.user.role}</dd>
                </div>
                <div>
